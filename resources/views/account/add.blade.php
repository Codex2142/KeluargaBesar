...
<body class="bg-green-50 min-h-screen flex items-center justify-center">
    ...
    <div class="w-full max-w-4xl px-4 py-6">
        ...
        <div class="bg-green-700 text-white rounded-t-lg p-4 shadow-md">
            <h2 class="text-2xl font-bold text-center">Tambah Pengguna</h2>
        </div>
        ...
        {{-- Form --}}
        <form id="addForm" action="{{ route('account.store') }}" method="POST" class="bg-sky-100 rounded-b-lg p-6 shadow-lg space-y-6">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="name" class="w-full rounded-md border border-green-300 focus:ring-2 focus:ring-green-400 shadow-sm py-2 px-3" placeholder="Masukkan Username" autocomplete="off" required>
                </div>

                {{-- Phone --}}
                <div>
                    <label class="block text-sm font-semibold text-green-800 mb-1">No HP</label>
                    <input type="text" name="phone" class="w-full rounded-md border border-green-300 focus:ring-2 focus:ring-green-400 shadow-sm py-2 px-3" placeholder="Masukkan Nomor HP" autocomplete="off" required>
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="password" name="password" class="w-full rounded-md border border-green-300 focus:ring-2 focus:ring-green-400 shadow-sm py-2 px-3" placeholder="Masukkan Password" required>
                </div>

                {{-- Confirm Password --}}
                <div>
                    <label class="block text-sm font-semibold text-green-800 mb-1">Konfirmasi Password</label>
                    <input type="password" name="password_confirmation" class="w-full rounded-md border border-green-300 focus:ring-2 focus:ring-green-400 shadow-sm py-2 px-3" placeholder="Konfirmasi Password" required>
                </div>
            </div>
